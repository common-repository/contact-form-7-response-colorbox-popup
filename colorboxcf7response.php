...
{
  return 'To use <i>Colorbox Contact Form Response</i> you need to have both <a href="plugin-install.php?tab=search&s=lightbox+plus+colorbox">Lightbox Plus Colorbox</a> and <a href="plugin-install.php?tab=search&s=contact+form+7">Contact Form 7</a> plugins installed and active for this plugin to work.<br/> Plugin would be inactive! After you make sure you have installed and activated all the required plugins you can reactivate it.';
}
function myplugin_activate() {

	if ( !(is_plugin_active( 'contact-form-7/wp-contact-form-7.php' ) && is_plugin_active( 'lightbox-plus/lightboxplus.php' ))) {
